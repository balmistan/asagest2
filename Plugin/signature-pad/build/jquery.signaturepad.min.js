...
updateOptions:function(a){c.extend(b,a);b.displayOnly?i.unbind("mousedown.signaturepad"):i.bind("mousedown.signaturepad")},regenerate:function(a){q.clearCanvas();c(b.typed,d).hide();if(typeof a==="string")a=JSON.parse(a);B(a,h,true);b.output&&c(b.output,d).length>0&&c(b.output,d).val(JSON.stringify(l))},clearCanvas:function(){t()},getSignature:function(){return l},getSignatureString:function(){return JSON.stringify(l)},getSignatureImage:function(){var a=document.createElement("canvas"),e=null;e=null;a.style.position="absolute";a.style.top="-999em";a.width=k.width;a.height=k.height;
