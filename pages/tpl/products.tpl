                            ...
                            {section name=xx loop=$arr_in["product_id"]}
                                ...
                                <tr>
                                    ...
                                    {else}  <!-- se non modificabile -->
                                        ...
                                        <td><label>Qtà/unità<span class="red">*</span>:</label><br /><input type="text" tabindex="3" name="qtyforunity[]" class = "mtf_textfield qta_tbox" value = "{$arr_in["qtyforunity"][xx]}" id = "qtyforunity[]"  /></td>
                                    ...
                                    <td class="rrr1">
                                        ...
                                        <center>
                                            ...
                                            <input type="hidden" class="rr2" name="rr2[]" value="{$arr_in["rr2"][xx]}" />       
                                            {if $arr_in["rr2"][xx] eq off}
