$(document).ready(function(){
    ...
    $("#change").click(function(){    
        $(location).attr('href','addmodcustomer.php?fid='+$("#idfamily").val());
    })
    ...
    $(".lk").click(function(){
        $(location).attr('href','block.php?pid='+$(this).parent("tr").find(".pid").val());
    })
    ...
    $(".topb").click(function(){
        ...
        if(keyv=="canc"){
            ...
            if(val_comp!="")
                $(location).attr('href', "viewcustomer.php?fid="+val_comp);
        }else{
