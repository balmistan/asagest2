$(document).ready(function(){
    ...
    if($("#correct_selected_block").val()=="FALSE")
        alert("l' anno di riferimento del blocchetto è diverso dall' anno corrente. E' possibile selezionare il blocchetto attuale andando in Configurazioni > Sistema ")
