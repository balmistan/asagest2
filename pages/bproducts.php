...
$nophoto = NOPHOTO;
$title = "Prodotti Banco Alimentare";
...
$product = new product(1);    //l' 1 setta l' utilizzo della tabella prodotti del banco alimentare.
...
$objSmarty->display('tpl/bproducts.tpl');
?>
