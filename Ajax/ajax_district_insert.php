...
$result_array=$db->getRows($tabellacomuni,array("nomeComune", "provincia"),
      array(
   ...
   foreach($result_array as $key => $arr_val){
       $result_array[$key]['nomeComune'] = $result_array[$key]['nomeComune']." (".$result_array[$key]['provincia'].")";    
   }
